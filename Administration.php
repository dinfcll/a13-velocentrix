        ...
        <div class="contenu border-radius">
            ...
            elseif($_POST['Query'] == "Proposition"){
                ...
                echo "<div class='span9'>
                 ...
                 echo "<h5>Proposition:</h5><select width='100%' name='proposition'>";while($row = mysql_fetch_array($result)){echo"<option value='".$row['idProposition']."'>"."Prénom:".$row['Prenom']."  Nom:".$row['Nom']."  Courriel".$row['Courriel']."  Sujet:".$row['Sujet']."</option>";} echo "</select>";
                 echo "</div>";
                }
                else{
